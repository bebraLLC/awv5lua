...
local base_hc = gui.GetValue("rbot.accuracy.weapon.asniper.hitchance")
missed_count = missed_count + 1
gui.SetValue("rbot.accuracy.weapon.asniper.hitchance", 5 * missed_count + base_hc:GetValue())
if timer.Exists("SetBaseHitchance") then
timer.Restart("SetBaseHitchance")
else
timer.Simple("SetBaseHitchance", 0.6, function()
gui.SetValue("rbot.accuracy.weapon.asniper.hitchance", base_hc:GetValue())
missed_count = 0
end)
end
end
