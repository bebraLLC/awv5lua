...
function BetterESP:hkLoad() -- ok not really callback function but idc
    ...
    for i=1, 2 do
        ...
        setVal("esp.overlay." .. p .. ".box", 0, true)
        setVal("esp.overlay." .. p .. ".precision", 0, true)
        setVal("esp.overlay." .. p .. ".name", 0, true)
        setVal("esp.overlay." .. p .. ".skeleton", 0, true)
        setVal("esp.overlay." .. p .. ".glow", 0, true)
        setVal("esp.overlay." .. p .. ".health.healthbar", 0, true)
        setVal("esp.overlay." .. p .. ".health.healthnum", 0, true)
        setVal("esp.overlay." .. p .. ".armorbar", 0, true)
        setVal("esp.overlay." .. p .. ".armornum", 0, true)
        setVal("esp.overlay." .. p .. ".weapon", 0, true)
        setVal("esp.overlay." .. p .. ".defusing", 0, true)
        setVal("esp.overlay." .. p .. ".planting", 0, true)
        setVal("esp.overlay." .. p .. ".scoped", 0, true)
        setVal("esp.overlay." .. p .. ".reloading", 0, true)
        setVal("esp.overlay." .. p .. ".flashed", 0, true)
        setVal("esp.overlay." .. p .. ".hasdefuser", 0, true)
        setVal("esp.overlay." .. p .. ".hasc4", 0, true)
        setVal("esp.overlay." .. p .. ".money", 0, true)
    end
