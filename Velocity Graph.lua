...
-- This script should scale well on every resolution
-- on really low resolutions speedGain and distance will be rendered outside of the box (in case it is enabled)
-- speed indicator font size also scales with resolution but speedGain and distance doesn't
-- Original by kermit, arpac,Rab,ambien55,tekno and kai
-- Fixed by Kawurftha
-- SETTINGS --
